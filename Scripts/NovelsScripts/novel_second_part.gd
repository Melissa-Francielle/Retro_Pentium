...
var third = preload("res://NovelsScenes/novel_third_part.tscn")

const dialog_lines : Array[String] = [
	"Oko:  	Oh não! O CPU esta colapsando!!",
	"Oko:  	Kodo! Cadê o Kodo? Ele deveria estar tomando conta do processador!",
	"Renkai:  	E ele esta! Ele esta na Ilha do Processador.",
	"Oko: 	... Então por que os alarmes estão soando?",
	"Renkai: 	Bom..."
]

func _ready():
	$backgroundSecond/AnimatedSprite2D.play("Background")
	dialog_index = 0
...
func load_next_cutscene():
	get_tree().change_scene_to_packed(third)
