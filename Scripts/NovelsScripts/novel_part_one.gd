...
var second = preload("res://NovelsScenes/novel_second_part.tscn")

const dialog_lines : Array[String] = [
	"Terry:  	Tks...",
	"Terry:  	Meu PC deu tela azul de novo, que merda!!!!",
	"Terry:  	Não consegui salvar o meu progresso.",
	"Terry:  	..."
]

func _ready():
	$Background/backgroundAnimation.play("backgroundfile")
	dialog_index = 0
...
func load_next_cutscene():
	get_tree().change_scene_to_packed(second)
